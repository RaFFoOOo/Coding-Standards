...
### CD Identity Separation [STRICT — Sprint 10 lesson]
...
### Shared Build Extraction [STRICT — Sprint 10 lesson]
...
### Azure Functions isolated worker — `.azurefunctions/` folder [STRICT — Sprint 10.5 lesson]
...
- uses: actions/upload-artifact@v7
  with:
    ...
    include-hidden-files: true   # required for .azurefunctions/ — see Sprint 10.5 lesson
```
